...
python $SRC/SV_support_read.2.py $OUTPUT/SV_read.txt.2 1500 CHR > $OUTPUT/CHR_candidate.txt
...
python ./src/SV_filter_for_comparison.py $OUTPUT/DEL_candidate.txt 0.05 20 800 1 > $OUTPUT/DEL_candidate.txt0

python ./src/SV_filter_for_comparison.py $OUTPUT/INS_candidate.txt 0.05 20 800 1 > $OUTPUT/INS_candidate.txt0

python ./src/SV_filter_for_comparison.py $OUTPUT/INV_candidate.txt 0.05 20 800 1 > $OUTPUT/INV_candidate.txt0

python ./src/SV_filter_for_comparison.py $OUTPUT/TRS_candidate.txt 0.05 20 800 1 > $OUTPUT/TRS_candidate.txt0

python ./src/SV_filter_for_comparison.py $OUTPUT/CHR_candidate.txt 0.05 20 800 1 > $OUTPUT/CHR_candidate.txt0
