...
#			if del_OL_length > 0 and float(del_OL_length)/float(read_l[i][6]) >= overlap_prop and float(del_OL_length)/float(read_l[j][6]) >= overlap_prop:
			if del_OL_length > 0 and float(del_OL_length)/float(SV_length_tmp) >= overlap_prop and float(del_OL_length)/float(SV_length_tmp) >= overlap_prop:
				found = 0
